...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Фев 25 2020 г., 12:57
...
CREATE TABLE `adress` (
  ...
  `house` text NOT NULL,
  `index_adress` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL
...
ALTER TABLE `basket`
  ...
  ADD CONSTRAINT `basket_ibfk_3` FOREIGN KEY (`buy_id`) REFERENCES `buy` (`id`);
