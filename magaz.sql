...
CREATE TABLE `adress` (
  ...
  `index_adress` text COLLATE utf8mb4_unicode_ci DEFAULT NULL
...
--
-- Дамп данных таблицы `buy_goods`
--

INSERT INTO `buy_goods` (`buy_id`, `good_id`, `count`) VALUES
(25, 3, 1),
(26, 32, 1),
(27, 2, 1),
(27, 9, 1);
...
INSERT INTO `favorites` (`user_id`, `good_id`) VALUES
(2, 2),
(2, 21);
...
INSERT INTO `user` (`id`, `name`, `surname`, `email`, `login`, `password`, `rank_id`) VALUES
...
--
-- Ограничения внешнего ключа таблицы `buy_goods`
--
ALTER TABLE `buy_goods`
  ADD CONSTRAINT `buy_goods_ibfk_1` FOREIGN KEY (`buy_id`) REFERENCES `buy` (`id`),
  ADD CONSTRAINT `buy_goods_ibfk_2` FOREIGN KEY (`good_id`) REFERENCES `goods` (`id`);
