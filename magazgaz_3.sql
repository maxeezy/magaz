CREATE DATABASE IF NOT EXISTS `magaz3`;
USE `magaz3`;
...
INSERT INTO `category` (`id`, `name`, `img`, `idid`) VALUES
(1, 'Joker & Harley', 'https://res.cloudinary.com/dhsrjlsya/image/upload/v1583513175/img/category/harleyj.jpg', 1),
(2, 'Star Wars', 'https://res.cloudinary.com/dhsrjlsya/image/upload/v1583513175/img/category/starwars.jpg', 6),
(3, 'Eat Sweet', 'https://res.cloudinary.com/dhsrjlsya/image/upload/v1583513174/img/category/eatsweet.jpg', 7),
(4, 'Gravity Fols', 'https://res.cloudinary.com/dhsrjlsya/image/upload/v1583513173/img/category/gravitifolz.jpg', 8),
(5, 'Harry Potter', 'https://res.cloudinary.com/dhsrjlsya/image/upload/v1583513173/img/category/harrypotter.jpg', 9),
(6, 'Znacki', 'https://res.cloudinary.com/dhsrjlsya/image/upload/v1583442851/img/category/znacki.jpg', 10),
(7, 'Memes', 'https://res.cloudinary.com/dhsrjlsya/image/upload/v1583442849/img/category/memes.jpg', 11),
(8, 'Batman', 'https://res.cloudinary.com/dhsrjlsya/image/upload/v1583442847/img/category/batman.jpg', 12),
(41, 'Passport', 'https://res.cloudinary.com/dhsrjlsya/image/upload/v1583442804/img/category/passport.jpg', 13),
(653, 'Anime', 'https://res.cloudinary.com/dhsrjlsya/image/upload/v1583442789/img/category/anime.jpg', 14),
(4469, 'Braces', 'https://res.cloudinary.com/dhsrjlsya/image/upload/v1583870538/img/brace-logo_snwhiw.png', 15);
...
(88, 3, 'Обложка на паспорт \"Футурама\"', 'Может так случиться, что вместо вторника будет четверг, а вместо среды — август, а вместо четверга — конец света!', 400, 'https://res.cloudinary.com/dhsrjlsya/image/upload/v1583860464/img/futurama2_ulelhs.png'),
(89, 3, 'Обложка на паспорт \"Бендер\"', 'Каждый раз, когда я говорил: «Смерть всем людям», шепотом добавлял: «Кроме одного». Им был Фрай. Я так ему и не сказал этого.', 400, 'https://res.cloudinary.com/dhsrjlsya/image/upload/v1583860462/img/bender_ydxkbj.png'),
(90, 3, 'Обложка на паспорт \"Том и Джерри\"', 'Мало кто знает, но в мультике Том и Джери изначально было 2 кота. Но по предложению Н.В. Гоголя 2 Том был сожжен\r\n', 400, 'https://res.cloudinary.com/dhsrjlsya/image/upload/v1583860462/img/tomjerry_sp2drb.png'),
(91, 3, 'Обложка на паспорт \"Рик\"', '— Мой сын собирается захватить планету, а я слишком молод, чтобы водить. Поможешь мне вернуть его? \r\n— Наверное, Морти, наверное. Но сначала глубокий глоток из большого стакана «я же тебе говорил».', 400, 'https://res.cloudinary.com/dhsrjlsya/image/upload/v1583860461/img/morty_on7up5.png'),
(92, 3, 'Обложка на паспорт \"Корги\"', 'Кажется, этот малыш учит нас оставаться верным себе, а не следовать за толпой', 400, 'https://res.cloudinary.com/dhsrjlsya/image/upload/v1583860459/img/corgi_bt3rzb.png'),
(93, 3, 'Обложка на паспорт \"Мстители\"', 'Пока Мстители и их союзники продолжают защищать мир от различных опасностей, с которыми не смог бы справиться один супергерой, новая угроза возникает из космоса: Танос. Межгалактический тиран преследует цель собрать все шесть Камней Бесконечности — артефакты невероятной силы, с помощью которых можно менять реальность по своему желанию. Всё, с чем Мстители сталкивались ранее, вело к этому моменту — судьба Земли никогда ещё не была столь неопределённой.', 400, 'https://res.cloudinary.com/dhsrjlsya/image/upload/v1583860455/img/avergents_cj3wju.png'),
(94, 2, 'Кулон \"Енотик\"', 'Юркий маленький зверёк,\r\nПолосатый поперёк.\r\nТёмно-жёлтый мех на нём,\r\nМы — енотом назовём.', 500, 'https://res.cloudinary.com/dhsrjlsya/image/upload/v1583864446/img/charm56_euzbda.png'),
(95, 2, 'Кулон \"Горы\"', 'Горные системы занимают около сорока процентов поверхности нашей планеты: их можно увидеть на каждом континенте, на многих островах и на океаническом дне. Меньше всего хребтов находится на австралийском континенте, а почти все горные хребты Антарктиды надёжно спрятаны подо льдом.\r\n\r\nПодробнее: https://awesomeworld.ru/nezhivaya-priroda/goryi.html', 500, 'https://res.cloudinary.com/dhsrjlsya/image/upload/v1583864444/img/charmou1_w435g0.png'),
(96, 2, 'Кулон \"Ракушка\"', 'Ракушки могут быть не только красивыми, но и ценными.\r\n\r\nНа многих территориях между Индийским и Тихим океанами ракушки некогда служили валютой.', 500, 'https://res.cloudinary.com/dhsrjlsya/image/upload/v1583864450/img/charm_74_tt8u7c.png'),
(97, 2, 'Кулон \"Ракушка\"', 'Ракушки могут быть не только красивыми, но и ценными.\r\n\r\nНа многих территориях между Индийским и Тихим океанами ракушки некогда служили валютой.', 500, 'https://res.cloudinary.com/dhsrjlsya/image/upload/v1583864445/img/charm_78_dpkopm.png'),
(98, 2, 'Кулон \"Древо жизни\"', 'Значение символа древо жизни показывает представление о мировом устройстве, месте человека на земле. Он имеет обобщенный собирательный образ. Изображается в виде переплетенных ветвей и корней в круге, тем самым подразумевая единство жизни и смерти, земного и духовного, прошлого и будущего.', 500, 'https://res.cloudinary.com/dhsrjlsya/image/upload/v1583864450/img/charm76_jlktrs.png');
...
--
ALTER TABLE `category`
  MODIFY `idid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
